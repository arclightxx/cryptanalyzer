...
public class ShiftConstants {
    ...
    public static final String SHIFT_INPUT_FIRST_MODE_MESSAGE = "Пожалуйста, напишите ключ для расшифровки (число должно быть положительным) или нажмите ENTER, чтобы выбрать случайный";
    public static final String SHIFT_INVALID_INPUT_MESSAGE = "Пожалуйста, используйте только положительные числа";
